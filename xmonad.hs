...
--  xmproc <- spawnPipe "xfce4-panel &"
    xmproc <- spawnPipe "xmobar -x 0 /home/rina/.config/xmobar/xmobarrc"
    xmproc <- spawnPipe "trayer --edge top --align right --SetPartialStrut true --expand true --width 1 --alpha 0 --tint 0x321450 --transparent true --SetDockType true --height 20 &"
